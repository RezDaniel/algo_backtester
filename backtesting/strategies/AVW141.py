...
log = MyLogger('results/logfile.txt', "AVW141.py", True)


class AVW141(BackTestSA):
...
if __name__ == '__main__':
    csv_path = "backtesting/data/results/AVW141/orders_dax_mar2023.csv"
    date_col = 'timestamp'

    srs = AVW141(csv_path, date_col)
    srs.run_backtest()
